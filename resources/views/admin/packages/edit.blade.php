    ...
    @section('content')
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
<form action="{{ route('admin.categories-packages.update',$package->id) }}" method="POST" enctype="multipart/form-data">
    @method('PATCH')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group ">
                                                <label >Trip ID</label>
                                                <input type="text" name="trip_id" class="form-control" required value="{{ $package->trip_id }}">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="slug" class="form-control" required value="{{ $package->url }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                         ...
                                         <select name="destination_id" id="destination_id"  class="form-control" required>
                                            ...
                                            @foreach ($destinations as $destination)
                                             <option value="{{ $destination->id }}" @if ($destination->id==$package->destination_id)
                                                 selected
                                        ...
                                        <div class="form-group ">
                                         ...
                                         <select name="category_destination_id" id="category_destination_id"  class="form-control" required>
                                             <option value="">--select category destination--</option>
                                            @foreach ($categories_destinations as $category_destination)
                                             <option value="{{ $category_destination->id }}" @if ($category_destination->id ==$package->category_destination_id)
                                                 selected
                                             @endif  class="@if ($category_destination->id !=$package->category_destination_id)
                                             d-none
                                         @endif ">{{ $category_destination->name }}</option>
                                            @endforeach
                                        </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">     
                                            <div class="col-md-12" id="addSelect">
                                                <div class="form-group">
                                                    ...
                                                    <label class="ckbox ckbox-success">
                                                        <input type="checkbox" name="popular_package" value="1"  @if ($package->deal==1)
                                                        checked
                                                    @endif>
    ...
    {{-- 
                                        ...
                                        <div class="form-group">
                                          ...
                                          <select name="rating"  class="form-control">
                                              ...
                                              <option value="1" @if ($package->rating==1)
                                                        selected
                                                    @endif>1 star</option>
                                              <option value="2" @if ($package->rating==2)
                                                selected
                                                    @endif>2 star</option>
                                              <option value="3" @if ($package->rating==3)
                                                selected
                                                    @endif>3 star</option>
                                              <option value="4" @if ($package->rating==4)
                                                selected
                                                    @endif>4 star</option>
                                              <option value="5" @if ($package->rating==5)
                                                selected
                                                    @endif>5 star</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order" class="form-control" min="1" value="{{ $package->order }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="activity" class="form-control"  value="{{ $package->activity }}">
                                        </div> 
                                        <div class="form-group">
                                            
                                            <label >Difficulty level</label>
                                            <input type="text" name="fitness_level" class="form-control"  value="{{ $package->fitness_level }}">
                                        </div>
                                        <div class="form-group">                                       
                                            <label >Max Altitude</label>
                                            <input type="text" name="max_altitude" class="form-control"  value="{{ $package->max_altitude }}">
                                        </div>
                                        <div class="form-group">
                                           
                                            <label >Transport</label>
                                            <input type="text" name="transport" class="form-control"  value="{{ $package->transport }}">
                                        </div> 
                                        <div class="form-group">
                                         <label >Best Month</label>
                                            <input type="text" name="best_month" class="form-control"  value="{{ $package->best_month }}">
                                        </div>
                                        <div class="form-group">
                                            <label >Group Size</label>
                                            <input type="text" name="group_size" class="form-control"  value="{{ $package->group_size }}">
                                        </div>
                                         <div class="form-group">
                                             <label >Enter Arrival</label>
                                            <input type="text" name="arrival" class="form-control"  value="{{ $package->arrival }}">
                                        </div>
                                        <div class="form-group">
                                            <label >Departure from</label>
                                            <input type="text" name="departure_from" class="form-control"  value="{{ $package->departure_from }}">
                                        </div>
                                        <div class="form-group">
                                            <label >Meals</label>
                                            <input type="text" name="meals" class="form-control"  value="{{ $package->meals }}">
                                        </div>
                                        <div class="form-group">
                                             <label >Room/Accomodation</label>
                                            <input type="text" name="room" class="form-control"  placeholder="Room/Accomodation" value="{{ $package->room }}">
                                        </div>
                                    </div>
                                </div>
                                <!-- ./ row -->
