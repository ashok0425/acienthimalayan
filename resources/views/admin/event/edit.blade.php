...
<x-errormsg/>
        <form action="{{route('admin.events.update',$event->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class=" col-md-6">
             ...
             <input name="title"   class='form-control' maxlength="225" value=' {{ $event->title }}' type='text' placeholder="Enter  Title">
            </div>
            <div class=" col-md-6">
                <label class="form-label"> Start Date</label>
             <input name="date"   class='form-control' maxlength="225" value=' {{ carbon\carbon::parse($event->date)->format('m d Y') }}' type='date' placeholder="Enter  Title">
             {{ carbon\carbon::parse($event->date)->format('m/d/Y') }}
            </div>

            <div class=" col-md-6">
                <label class="form-label"> End Date</label>
             <input name="end_date"   class='form-control' maxlength="225" value=' {{ carbon\carbon::parse($event->end_date)->format('m d Y') }}' type='date' placeholder="Enter  Title">
