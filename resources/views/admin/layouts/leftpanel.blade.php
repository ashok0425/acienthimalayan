...
<li class="nav-item <?php  echo Request::segment(2)=='categories-destinations'?'menu-open':'' ?>">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="{{route('admin.categories-destinations.index')}}" class="nav-link <?php  echo Request::segment(3)==''?'active':'' ?>">
        <i class="far fa-circle nav-icon"></i>
        <p>Category</p>
      </a>
    </li>
    <li class="nav-item ">
      <a href="{{route('admin.categories-destinations.create')}}" class="nav-link <?php  echo Request::segment(3)=='create'?'active':'' ?>">
        <i class="far fa-circle nav-icon"></i>
        <p>Add Category </p>
      </a>
    </li>
...
<li class="nav-item <?php  echo Request::segment(2)=='categories-packages'?'menu-open':'' ?>">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="{{route('admin.categories-packages.index')}}" class="nav-link <?php  echo Request::segment(3)==''?'active':'' ?>">
        <i class="far fa-circle nav-icon"></i>
        <p>View Packages</p>
      </a>
    </li>
    <li class="nav-item ">
      <a href="{{route('admin.categories-packages.create')}}" class="nav-link <?php  echo Request::segment(3)=='create'?'active':'' ?>">
        <i class="far fa-circle nav-icon"></i>
        <p>Add Packages </p>
      </a>
    </li>
...
<li class="nav-item <?php  echo Request::segment(2)=='newsletters'?'menu-open':'' ?>">
  ...
  <ul class="nav nav-treeview">
    ...
    <li class="nav-item ">
      <a href="{{route('admin.newsletters.history')}}" class="nav-link <?php  echo Request::segment(3)=='emailhistory'?'active':'' ?>">
        <i class="far fa-circle nav-icon"></i>
        <p>Email History </p>
      </a>
    </li>
...
<li class="nav-item <?php  echo Request::segment(2)=='contacts'?'menu-open':'' ?>">
  ...
  <ul class="nav nav-treeview">
    ...
    <li class="nav-item ">
      <a href="{{route('admin.contacts.index')}}" class="nav-link <?php  echo Request::segment(3)==''?'active':'' ?>">
        <i class="far fa-circle nav-icon"></i>
        <p>View All </p>
      </a>
    </li>
...
<li class="nav-item <?php  echo Request::segment(2)=='websites'?'menu-open':'' ?>">
  ...
  <ul class="nav nav-treeview">
    ...
    <li class="nav-item ">
      <a href="{{route('admin.section-control.index')}}" class="nav-link <?php  echo Request::segment(3)=='emailhistory'?'active':'' ?>">
        <i class="far fa-circle nav-icon"></i>
